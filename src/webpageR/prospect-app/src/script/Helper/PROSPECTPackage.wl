...
parseS::usage="Parsing input string"
...
generateDataS::usage="Generates the data from a string"
...
(* Generate data function *)
generateDataS::invalidCase="No such case exists";
Clear[generateDataS];
...
"timeinvariant", result = invariantGenerate[]; result,
"timevariant", result = variantGenerate[]; result,
_, Message[generateDataS::invalidCase]; $Failed
]
]
